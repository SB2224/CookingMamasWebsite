...
function onloadBreakfast() {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    if (i === 0) {
        ...
        document.getElementById("description").innerTex = description;
    } else if (i === 1) {
        document.getElementById("rtitle1").innerText = title;
        document.getElementById("description1").innerTexL = description;
    } else if (i === 2) {
        document.getElementById("rtitle2").innerText = title;
        document.getElementById("description2").innerTex = description;
    } else if (i === 3) {
        document.getElementById("rtitle3").innerText = title;
        document.getElementById("description3").innerTex = description;
    } else if (i === 4) {
        document.getElementById("rtitle4").innerText = title;
        document.getElementById("description4").innerTex = description;
    } else if (i === 5) {
      document.getElementById("rtitle5").innerText = title;
      document.getElementById("description5").innerTex = description;
  }
}
